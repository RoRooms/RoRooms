...
local NexusVR = require(RoRooms.SourceCode.Shared.ExtPackages.NexusVRCharacterModel)
...
local NEXUS_VR_CONFIGURATION = {
	...
	Camera = {
		...
		DisableFadeOutViewOnCollision = true,
	},
	Movement = {
...
local NexusVRService = {
	Name = "NexusVRService",
}

function NexusVRService:KnitStart()
	NexusVR:SetConfiguration(NEXUS_VR_CONFIGURATION)
	NexusVR:Load()
end

function NexusVRService:KnitInit() end

return NexusVRService
