...
return function(Scope: Fusion.Scope<any>, Props)
	Props.SizeMultiplier = Scope:EnsureValue(Props.SizeMultiplier, 1)
	Props.IconImage = Scope:EnsureValue(Props.IconImage, "")
	Props.MenuName = Scope:EnsureValue(Props.MenuName, "")
	Props.Icon = Scope:EnsureValue(Props.Icon, "")
	Props.IconFilled = Scope:EnsureValue(Props.IconFilled, "")
	local IndicatorEnabled = Scope:EnsureValue(Props.IndicatorEnabled, false)
	local IndicatorColor = Scope:EnsureValue(Props.IndicatorColor, Color3.fromRGB(255, 255, 255))
