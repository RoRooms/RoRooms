...
return function(Scope: Fusion.Scope<any>, Props)
	Props.UserId = Scope:EnsureValue(Props.UserId, 1)
	Props.DisplayName = Scope:EnsureValue(Props.DisplayName, "DisplayName")
	Props.PlaceId = Scope:EnsureValue(Props.PlaceId, nil)
	Props.JobId = Scope:EnsureValue(Props.JobId, nil)
	Props.InRoRooms = Scope:EnsureValue(Props.InRoRooms, false)
